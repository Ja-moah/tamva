...
export default function HomeScreen() {
  ...
  const cardColumns = width >= 1100 ? 4 : 2;
    ...
    <View className="flex-1 bg-cloud">
      ...
      <SafeAreaView className="flex-1">
        <ScrollView
          ...
          contentContainerStyle={{ alignSelf: "center", maxWidth: 1180, width: "100%" }}
        ...
        >
          ...
          <View className="mt-4 flex-row flex-wrap justify-between gap-y-3">
            {features.map((feature) => (
              <FeatureCard key={feature.title} {...feature} columns={cardColumns} />
            ))}
          </View>
          ...
          <View className="mt-6 rounded-3xl border border-slate-200 bg-white p-5">
            ...
            <Text className="mt-2 text-sm leading-6 text-slate-500">
              The app displays decisions from TAMVA’s Django API. Consent, risk, access, and financial calculations never run in the customer client.
            </Text>
          </View>
        </ScrollView>
      </SafeAreaView>
