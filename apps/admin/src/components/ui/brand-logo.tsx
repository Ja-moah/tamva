...
> = {
  mtn: {
    ...
    tag: "MoMo Rail",
    src: "/assets/logos/mtn-momo.svg",
    fallbackBg: "bg-[#FFCC00] text-[#002B49]",
    fallbackText: "MTN",
  },
  telecel: {
    name: "Telecel Cash",
    tag: "Cash Rail",
    src: "/assets/logos/telecel-cash.svg",
    fallbackBg: "bg-[#E60000] text-white",
    fallbackText: "TC",
  },
  airteltigo: {
    name: "AirtelTigo Money",
    tag: "AT Money Rail",
    src: "/assets/logos/airteltigo-money.svg",
    fallbackBg: "bg-[#0055A5] text-white",
    fallbackText: "AT",
  },
  apex: {
    name: "Apex Bank PLC",
    tag: "Commercial Core",
    src: "/assets/logos/apex-bank.svg",
    fallbackBg: "bg-[#0F2B48] text-[#F3C64D]",
    fallbackText: "APEX",
  },
  ecobank: {
    name: "Ecobank Regional Hub",
    tag: "PAPSS Regional",
    src: "/assets/logos/ecobank.svg",
    fallbackBg: "bg-[#005B94] text-white",
    fallbackText: "ECO",
  },
  zenith: {
    name: "Zenith Digital Trust",
    tag: "FinTech Rail",
    src: "/assets/logos/zenith-bank.svg",
    fallbackBg: "bg-[#1A202C] text-[#E53E3E]",
    fallbackText: "ZTH",
  },
  ghipss: {
    name: "GhIPSS National Switch",
    tag: "GIP Core Switch",
    src: "/assets/logos/ghipss.svg",
    fallbackBg: "bg-[#0F2B48] text-white",
    fallbackText: "GIP",
  },
};
...
export function BrandLogo({
  ...
  const config = brandConfig[matchedKey] || {
    ...
    tag: "Institutional",
    src: "",
    fallbackBg: "bg-slate-700 text-slate-100",
